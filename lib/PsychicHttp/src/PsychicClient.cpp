...
{
  // Defensive checks: during shutdown, callers may race with httpd close callbacks.
  // Avoid passing clearly invalid handles/sockets to ESP-IDF.
  if (_server == nullptr || _socket < 0) {
